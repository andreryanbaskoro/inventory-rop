                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row g-2 mt-2">
                                <div class="col-md-12">
                                    ...
                                    <input type="text" name="satuan" id="inputSatuanDasar" value="{{ old('satuan', $barang->satuan) }}" class="form-control border-2" placeholder="Contoh: PCS / BUNGKUS / KILOGRAM" required>
                                </div>
                                <div class="col-md-12 mt-3">
                                    <div class="form-check form-switch form-switch-lg">
                                        <input class="form-check-input" type="checkbox" role="switch" id="toggleSatuanBesar" style="cursor:pointer;" {{ old('satuan_besar', $barang->satuan_besar) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-12" id="containerSatuanBesar" style="display: {{ old('satuan_besar', $barang->satuan_besar) ? 'block' : 'none' }};">
                                    <div class="p-3 bg-white border-2 rounded d-flex flex-wrap align-items-center gap-3 shadow-sm mt-1">
                                        ...
                                        <input type="text" name="satuan_besar" id="inputSatuanBesar" value="{{ old('satuan_besar', $barang->satuan_besar) }}" class="form-control text-center fw-bold border-2 text-primary" style="width: 140px; text-transform: uppercase;" placeholder="Contoh: DUS">
                                        <span class="fw-bold fs-5 text-muted">berisi</span>
                                        <input type="number" name="isi_per_satuan_besar" id="inputIsi" value="{{ old('isi_per_satuan_besar', $barang->isi_per_satuan_besar) }}" class="form-control text-center fw-bold border-2 text-primary" style="width: 100px;" min="2" placeholder="24">
