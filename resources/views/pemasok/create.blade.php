                        ...
                        <div class="card-body p-3">
                            ...
                            <div class="row g-3 mb-3">
                                <div class="col-6 col-md-3">
                                    ...
                                    <input type="number" id="inputHari" name="rata_lead_time" value="{{ old('rata_lead_time', 1) }}"
                                        class="form-control form-control-sm" min="0" placeholder="0">
                                </div>
                                <div class="col-6 col-md-3">
                                    <label class="form-label text-secondary small fw-bold">Menit</label>
                                    <input type="number" id="inputMenit" name="rata_lead_time_menit" value="{{ old('rata_lead_time_menit', 0) }}"
